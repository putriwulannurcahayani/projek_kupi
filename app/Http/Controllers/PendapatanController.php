...
class PendapatanController extends Controller
{
    public function index():View
    {
        ...
        return view('pendapatan/index', compact('pendapatans')); // Mengirimkan pendapatan ke dalam view
    }
    public function creatependapatan()
    {
        // Logika untuk menampilkan formulir pembuatan pendapatan
        return view('pendapatan.create'); // Gantilah 'pendapatan.create' dengan nama view yang sesuai
    }
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return redirect()->route('pendapatans.index')
            ->with('success', 'Produk berhasil ditambahkan'); // Redirect ke halaman detail pendapatan dengan pesan sukses
    }
